    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    port1.excCommand(Port_2.Command.SEND_SMS, new Message_1.Message("Test goi tin nhan1111", "0938256706"));
                    return [4, sleep(2000)];
                case 2:
                    _a.sent();
                    port1.excCommand(Port_2.Command.READ_SMS, new Message_1.Message("", ""));
                    return [2];
            }
        });
    });
